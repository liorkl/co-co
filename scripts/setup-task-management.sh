...
create_task_label "size:medium" "fef2c0" "Medium task (1-3 days)"
create_task_label "size:large" "fad8c7" "Large task (3+ days)"
create_task_label "size:epic" "5319e7" "Epic (multiple sprints)"
...
echo "3. Name it: 'Co-Co Backlog' (or 'FounderFinder Backlog', 'Development Board', etc.)"
